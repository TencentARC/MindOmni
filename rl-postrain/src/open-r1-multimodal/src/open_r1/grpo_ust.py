...
class GRPOScriptArguments(ScriptArguments):
    ...
    qwen2phi_module_origin_path: Optional[str] = field(
        default=None,
        metadata={"help": "ckpt of connector"},
    )
    val_iter: Optional[int] = field(
        default=50,
        metadata={"help": "validate iter number"},
    )
    diff_beta: Optional[float] = field(
        default=0.01,
        metadata={"help": "diffusion kl coef"},
    )
...
def main(script_args, training_args, model_args):
    ...
    trainer = trainer_cls(
        ...
        val_iter=script_args.val_iter,
        qwen2phi_module_origin_path=script_args.qwen2phi_module_origin_path,
    )
